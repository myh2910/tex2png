...
\begin{figure}[h]
  \begin{tikzpicture}[thick]
    ...
    \tkzMarkAngles[size=\a](B,A,C C,B,A B,C,D)
...
\begin{figure}[h]
  \begin{tikzpicture}[thick]
    ...
    \tkzMarkAngles[size=5mm](C,A,B A,B,C D,C,B)
  ...
  \begin{center}
    \begin{tikzpicture}[thick]
      ...
      \draw (A) node[below left] {$A$}%
        -- node[below] {$x+5$} (B) node[below right] {$B$}%
        -- node[above right] {$x$} (C) node[above] {$C$}%
        -- node[above left] {$x+3$} (A);
    \end{tikzpicture}
  \end{center}
\end{mini}
%%a05
...
\begin{figure}[h]
  \begin{tikzpicture}[thick]
    ...
    \tkzMarkAngles[size=\a](B,A,C C,B,A A,C,B)
...
\begin{figure}[h]
  \begin{tikzpicture}[thick]
    ...
    \tkzMarkAngles[size=5mm](B,C,D C,D,A)
...
\begin{figure}[h]
  \begin{tikzpicture}[thick]
    ...
    \tkzMarkAngles[size=\r](A,B,C B,C,D)
...
%%p14.sp
\begin{mini}
  Si se triplica el número de lados de un polígono, la suma de sus ángulos
  internos queda quintuplicada. ¿Cómo se llama dicho polígono?
\end{mini}
%%a14
\begin{enum}
  * Triángulo
