...
\begin{figure}[h]
  \begin{tikzpicture}[thick]
    ...
    \tkzMarkAngles[size=5mm](A,B,C B,D,C)
...
\begin{figure}[h]
  \begin{tikzpicture}[thick]
    ...
    \tkzMarkAngles[size=4mm](A,O,B O,B,C)
...
\begin{figure}[h]
  \begin{tikzpicture}[thick]
    ...
    \tkzMarkAngles[size=4mm](D,A,B A,B,C B,C,D C,D,A)
...
\begin{figure}[h]
  \begin{tikzpicture}[thick]
    ...
    \tkzMarkAngles[size=6mm,mark=|,mksize=2](B,C,I I,C,A)
    \tkzMarkAngles[size=6mm](C,A,I I,A,B)
    \tkzMarkAngles[size=5.1mm](C,A,I I,A,B)
    \tkzFillAngles[size=4mm,fill=green,opacity=.2](B1,B,A I1,I,A)
    \tkzMarkAngles[size=4mm](B1,B,A I1,I,A)
    \tkzDrawPolygon(A,B,C)
    \tkzDrawSegment(B1,B)
    \tkzDrawSegment(A,I)
    \tkzDrawSegment(I1,C)
...
\begin{figure}[h]
  \begin{tikzpicture}[thick]
    ...
    \tkzMarkAngles[size=6mm](A,B,C A,I,C B,C,I I,C,A C,A,I I,A,B)
    \tkzDrawPolygon(A,B,C)
    \tkzDrawPolySeg(A,I,C)
...
\begin{figure}[h]
  \begin{tikzpicture}[thick]
    ...
    \tkzMarkAngles[size=5mm](E,A,B A,B,C B,C,D C,D,E D,E,A)
...
\begin{figure}[h]
  \begin{tikzpicture}[thick]
    ...
    \tkzMarkAngles[size=5mm](D,A,B A,B,C B,C,D)
    \tkzMarkAngle[size=3.5mm](C,D,A)
    \tkzDrawPolygon(A,B,C,D)
...
\begin{figure}[h]
  \begin{tikzpicture}[thick]
    ...
    \tkzMarkAngles[size=\a](k,f,g f,g,h g,h,i h,i,j i,j,k j,k,f)
...
\begin{tabular}{c}
  ...
  \begin{tikzpicture}[thick]
    ...
    \tkzMarkAngles[size=5mm](P20,T1,X Y,T2,P2)
...
\begin{figure}[h]
  \begin{tikzpicture}[thick]
    ...
    \tkzMarkAngles[size=5mm](B,A,E A,E,D E,D,C D,C,B C,B,A)
