...
\begin{tikzpicture}[thick]
	...
	\node[above right] at (.1,0) {$x-2\vphantom{3x^3+5x^2+2x+3}$};
	\draw (0,.6) -- (0,0) -- (1.25,0);
\end{tikzpicture}
%%p05
\begin{tikzpicture}[thick]
...
\begin{tikzpicture}[thick]
	...
	\node[above right] at (.1,.0) {$x+2\vphantom{3x^2-2x-8}$};
	\draw (0,.6) -- (0,0) -- (1.25,0);
\end{tikzpicture}
%%p09
...
\begin{tikzpicture}[thick]
	...
	\node[above right] at (.1,0) {$3x^2+2x+1\vphantom{6x^5-8x^4-3x^2+4x+1}$};
	\draw (0,.6) -- (0,0) -- (2.25,0);
\end{tikzpicture}
%%p13
\begin{tikzpicture}[thick]
